...
export default function SettingsPage() {
  ...
  const handleSaveSettings = () => {
    console.log('Saving settings:', { notifications, privacy, aiSettings, theme });
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        <select className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white text-gray-900 shadow-sm appearance-none">
                          ...
                          <option value="America/New_York" className="text-gray-900">Eastern Time</option>
                          <option value="America/Los_Angeles" className="text-gray-900">Pacific Time</option>
                          <option value="Europe/London" className="text-gray-900">London</option>
                          <option value="Asia/Tokyo" className="text-gray-900">Tokyo</option>
                        </select>
                      </div>
                    </div>
                  </div>
